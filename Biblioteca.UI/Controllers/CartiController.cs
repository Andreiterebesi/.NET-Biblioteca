...
namespace Biblioteca.UI.Controllers
{
    public class CartiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarteID,Titlu,Autor,AnAparitie")] Carte carte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarteID,Titlu,Autor,AnAparitie")] Carte carte)
        {
            if (ModelState.IsValid)
            {
